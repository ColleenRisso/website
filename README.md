...
What more can I say? This is where I want to showcase myself and my works.

## Built With

### Stack

NERP Stack: Node, Express, React, PSQL

### Additional Frameworks

React-Redux, Semantic-UI-React, OAuth

### Boilerplate Code

This project was built on boiler plate code. To update, run the following commands in the CLI:
...
To start the server and run webpack simultaneously, use the command `npm run start-dev`
